...
class Extract:
    ...
    def get_news_extract(self):
        response = requests.get(
            'https://newsapi.org/v2/everything?q=' + self.name + '&from=2019-07-06&sources=the-wall-street-journal,the-verge,techcrunch,cnbc,cnn,engadget,the-new-york-times,the-economist,techradar,reuters,google-news,financial-post,business-insider,bloomberg&pageSize=100&sortBy=publishedAt&apiKey=30f781a305e34b55bcb18fd76d3fbd8c'
        )
        # Print the status code of the response.
