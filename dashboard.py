...
app.layout = html.Div([
    ...
    html.Div([
        dcc.Dropdown(id='my-dropdown',
                options=[{'label': 'Microsoft', 'value': 'MSFT'},{'label': 'Apple', 'value': 'AAPL'},{'label': 'Google', 'value': 'GOOG'}],
                value='MSFT',
    ...
    dcc.Graph(id='my-graph', style={'textAlign': 'center', 'align': 'center', 'width':'70%'  ,'margin': '0px auto', 'background-color': 'black' }, config={'displayModeBar': False},   ),
    ...
    html.Table([
        ...
        style={'textAlign': 'center', 'align': 'center', 'width':'70%', 'margin': '0px auto' }
    ) ,
...
def update_news_feed(selected_dropdown_value):
    ...
    return html.Table(
        ...
        [html.Tr([html.Td(html.Th('Description') , style={  'colspan': '5'  }),
            html.Td(html.Th('Sentiment') , style={'width':'27%', })],
